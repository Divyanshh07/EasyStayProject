        ...
        fetch("http://localhost:8081/api/properties/all")
            ...
            .then(data => {
                ...
                const buyProperties = data.filter(
                    p => p.listingType?.toLowerCase() === "buy"
                );

                // Ensure price is number
                const cleaned = buyProperties.map(p => ({
                    ...p,
    ...
    return (
        <div className="p-15 bg-gray-100 min-h-screen">
            ...
            <div className="max-w-6xl mx-auto mb-6">
                <h1 className="text-3xl font-bold text-gray-800">Buy Properties</h1>
                <p className="text-gray-600 mt-1">
                    Explore premium properties available for sale.
                </p>
            </div>
