...
const RentPage = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:8081/api/properties/all")
            .then(res => res.json())
            .then(data => {
                const rentProperties = data.filter(p => p.listingType === "Rent");
    ...
    return (
        <div className="p-15 bg-gray-100 min-h-screen">
            ...
            <div className="max-w-6xl mx-auto mb-6">
                <h1 className="text-3xl font-bold text-gray-800">Rent Properties</h1>
                <p className="text-gray-600 mt-1">
                    Explore rental properties available in your preferred city.
                </p>
            </div>
